...
const MainContent = ({ topic, handleAddPoints, handleResetResult }) => {
  ...
  // State holding a boolean parameter to disable click answers
  ...
  // Function for getting data from the back-end depends on the Topic end-point
  useEffect(() => {
  ...
  function randomArray(obj) {
    // Make an object with the question answers
    const value = {
      a: obj.opta,
      b: obj.optb,
      c: obj.optc,
  ...
  // Function for setting the next question as actual question and randomise the answers
